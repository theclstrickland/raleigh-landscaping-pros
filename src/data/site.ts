...
export const site = {
  ...
  services: [
    {
      ...
      benefits: [
        'Weekly or bi-weekly mowing programs',
        'Custom fertilization & weed control plans',
        'Core aeration & overseeding',
        'Seasonal cleanups (spring & fall)',
        'Irrigation system checks included',
    ...
    },
    {
      ...
      benefits: [
        ...
        'Native & climate-adapted plant selections',
        'Foundation plantings & curb appeal packages',
        'Grading & drainage solutions included',
        'Drip irrigation installation',
        '1-year plant replacement guarantee',
      ],
    ...
    },
    {
      ...
      benefits: [
        ...
        'Proper drainage & base engineering',
      ],
    ...
    },
    {
      ...
      benefits: [
        'Hardwood mulch, pine straw, or decorative stone',
        'Precise bed edging & shaping',
        'Weed removal & pre-emergent treatment',
        'Shrub pruning & dead-heading',
        'Bulk mulch delivery available',
        'Spring & fall refresh programs',
      ],
    ...
    },
    {
      ...
      benefits: [
        ...
        'Shrub pruning on seasonal schedules',
    ...
    },
    {
      ...
      icon: '🏡',
      short: 'New sod installation, lawn renovation, and turf replacement — instant green for your yard.',
      headline: 'Sod Installation in Raleigh, NC',
      intro: 'Whether you\'re starting from bare dirt on new construction or replacing a tired lawn, professional sod installation gives you an instant, established yard. We source locally grown turf matched to your property\'s conditions.',
      body: 'Sod installation in Raleigh is most successful when matched to your property\'s sun exposure and use case. Full-sun yards do best with Bermuda or Zoysia sod. Shaded areas need a quality Tall Fescue or Fine Fescue blend. Our installation process starts with soil testing and amendment — Raleigh\'s clay soils often need gypsum and organic matter worked in before laying sod. We grade the surface for proper drainage, lay sod in a staggered brick pattern with tight seams, roll for root contact, and set up a watering schedule to get you through the critical first 2-3 weeks of establishment. We source our sod from Triangle-area farms so it\'s fresh-cut and adapted to local conditions.',
      benefits: [
        'Bermuda, Zoysia, and Fescue varieties',
        'Soil testing & amendment included',
        'Proper grading for drainage',
        'Same-day installation from harvest',
        'Post-install watering schedule & care guide',
        'New construction & full renovation projects',
      ],
  ...
  locations: [
    {
      ...
      slug: 'cary',
      county: 'Wake',
      description: 'Serving Cary\'s established neighborhoods and growing subdivisions with full-service landscaping, lawn care, and hardscaping. From Preston to Lochmere, we know Cary\'s HOA standards and design expectations.',
    },
    {
      name: 'Apex',
      slug: 'apex',
      county: 'Wake',
      description: 'Professional landscaping for Apex homeowners — from historic downtown properties to the Bella Casa and Scotts Mill communities. We handle lawn care, landscape design, and outdoor living installations across Apex.',
    },
    {
      name: 'Holly Springs',
      slug: 'holly-springs',
      county: 'Wake',
      description: 'Full-service landscaping for Holly Springs\' rapidly growing communities. Whether you need lawn maintenance for a new build or a complete landscape transformation, we serve all of Holly Springs and the 12 Oaks area.',
    },
    {
      name: 'Wake Forest',
      slug: 'wake-forest',
      county: 'Wake',
      description: 'Landscaping and lawn care for Wake Forest residents — from Heritage to Hasentree. We provide year-round maintenance, seasonal plantings, and hardscape installations throughout Wake Forest.',
    },
    {
      name: 'Garner',
      slug: 'garner',
      county: 'Wake',
      description: 'Reliable landscaping services for Garner homeowners. We handle lawn care, mulch installation, tree trimming, and full landscape renovations across Garner and the White Oak area.',
    },
    {
      name: 'Fuquay-Varina',
      slug: 'fuquay-varina',
      county: 'Wake',
      description: 'Professional landscaping for Fuquay-Varina — from downtown to the Bentwinds and Southgate communities. Lawn care, landscape design, hardscaping, and seasonal maintenance programs.',
    },
    {
      name: 'Knightdale',
      slug: 'knightdale',
      county: 'Wake',
      description: 'Serving Knightdale\'s growing neighborhoods with expert lawn care, landscape installation, and hardscaping. From Widewaters to Planters Walk, we keep Knightdale properties looking sharp.',
    },
    {
      name: 'Durham',
      slug: 'durham',
      county: 'Durham',
      description: 'Extending our professional landscaping services to Durham homeowners. Lawn maintenance, landscape design, hardscaping, and seasonal programs — serving Durham, Southpoint, and Research Triangle Park areas.',
    },
  ],

  // ── Why Us / Trust Signals ─────────────────────────────
  whyUs: [
    { icon: '✅', title: 'Licensed & Insured', text: 'Fully licensed NC landscape contractor with general liability and workers\' comp coverage on every crew.' },
    { icon: '📋', title: 'Free Estimates', text: 'Detailed written estimates with clear scope, materials, and pricing — no surprises, no hidden fees.' },
    { icon: '🌱', title: 'Local Plant Expertise', text: 'We know which plants thrive in Wake County\'s Zone 7b/8a climate and heavy clay soils.' },
    { icon: '⏰', title: 'Reliable Scheduling', text: 'Consistent weekly service with GPS route tracking. You\'ll know when we\'re coming and when we\'re done.' },
    { icon: '💬', title: 'Responsive Communication', text: 'Direct line to your account manager. Texts, calls, and emails answered same-day.' },
    { icon: '🏆', title: 'Satisfaction Guaranteed', text: 'If you\'re not happy with a service visit, we\'ll come back and make it right at no charge.' },
  ],
  ...
  faqs: [
    {
      q: 'What areas do you serve around Raleigh?',
      a: 'We serve all of Wake County including Raleigh, Cary, Apex, Holly Springs, Wake Forest, Garner, Fuquay-Varina, Knightdale, and Morrisville. We also extend into parts of Durham and Johnston counties for larger projects.',
    },
    {
      q: 'How often should I have my lawn mowed in Raleigh?',
      a: 'During the active growing season (April through October), weekly mowing is ideal for Bermuda and Zoysia lawns. Fescue lawns can go 7-10 days between cuts. In winter, most lawns need mowing every 2-3 weeks or not at all depending on the turf type.',
    },
    {
      q: 'Do you offer contracts or can I pay per visit?',
      a: 'Both. We offer monthly maintenance agreements for lawn care and landscape maintenance, but we also do one-time projects like mulching, sod installation, and hardscaping. No long-term contracts are required for any service.',
    },
    {
      q: 'When is the best time to install new landscaping in Raleigh?',
      a: 'Fall (September through November) is the best time to install trees, shrubs, and perennials in the Triangle — cooler temperatures and fall rains help roots establish before summer heat. Spring works well too. We avoid major plantings in July and August unless irrigation is in place.',
    },
    {
      q: 'Do you handle HOA-required landscaping standards?',
      a: 'Yes. Many Raleigh-area HOAs have specific landscaping requirements for bed maintenance, lawn height, tree clearance, and seasonal color. We work with HOA guidelines and can coordinate directly with your management company if needed.',
    },
    {
      q: 'What type of mulch do you recommend for Raleigh?',
      a: 'Double-shredded hardwood mulch is the most popular and cost-effective choice for the Triangle. It breaks down slowly, retains moisture well, and looks clean. For a more natural look, we also install long-leaf pine straw, which is abundant in eastern NC and works great on slopes.',
    },
  ],

  // ── Footer ─────────────────────────────────────────────
  disclaimer:
    'Raleigh Landscaping Pros is a locally owned and operated landscaping company serving the Raleigh-Durham metro area.',
};
